...
# collect R1
r1_files=(data/raw/*_1.fastq.gz)
if [ ${#r1_files[@]} -eq 0 ]; then
    echo "!!! ERROR: No files found matching *_1.fastq.gz in data/raw"
...
1. **Volcano (p-value cutoff)**  
   - Highlights genes with raw *p < 0.05* and |log2FC| ≥ 1.  
...
2. **Volcano (padj cutoff)**  
   - Applies **Benjamini-Hochberg FDR correction** (*padj < 0.05*).  
